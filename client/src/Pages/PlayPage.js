      ...
      <div>
        ...
        <p>Wallet: ${ this.state.wallet }</p>
        {
          ...
          <div className="input-bet">            
            ...
            <Button variant="warning" onClick={() => {this.placeBet()}}>Place Bet</Button>
          </div>
          : null
        }
        {
          this.state.gameOver ?
          <div className="buttons">
            <Button variant="dark" onClick={() => {this.startNewGame('continue')}}>Continue</Button>
          </div>
          : null
        }
